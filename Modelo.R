...
#Obtendo os dados da Empresa e fazendo manipulação
...
# Plot do Log do retorno da Vale**
...
## Estatísticas básicas sobre as séries
...
# Função Arch test para realizar testes
